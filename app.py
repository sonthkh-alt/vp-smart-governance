...
# Thêm CSS tùy chỉnh để làm nổi bật thiết kế
st.markdown("""
    <style>
    .main-header {
        color: #1D3557;
...
st.markdown("<h1 class='main-header'>HỆ THỐNG TRỢ LÝ ẢO THAM MƯU VĂN BẢN <br>ĐOÀN ĐBQH & HĐND TỈNH THANH HÓA</h1>", unsafe_allow_html=True)

...
def generate_document_content(prompt, doc_type="Tự động nhận diện (Để AI tự quyết định)",
    ...
    parts = [
        ...
        "QUAN ĐIỂM PHÁP LÝ: Khi nội dung tham mưu có liên quan đến tổ chức bộ máy, thẩm quyền của chính quyền địa phương, BẮT BUỘC phải căn cứ theo Luật Tổ chức chính quyền địa phương số 72/2025/QH15. Đối với các lĩnh vực khác, hãy sử dụng căn cứ pháp lý chuyên ngành tương ứng.",
        "TRA CỨU INTERNET: Bạn BẮT BUỘC phải sử dụng công cụ tìm kiếm (Google Search) để cập nhật các Luật, Nghị định, Thông tư và quy định mới nhất liên quan đến yêu cầu tham mưu. Tuyệt đối không sử dụng các quy định cũ đã hết hiệu lực.",
        "LƯU Ý VỀ LUẬT 72/2025/QH15: Kể từ 01/7/2025, chính quyền địa phương chuyển sang mô hình 2 CẤP (Tỉnh và Xã), không tổ chức chính quyền cấp Huyện. Phải tuân thủ triệt để nguyên tắc phân cấp, phân quyền và đẩy mạnh chuyển đổi số theo Luật này khi có liên quan.",

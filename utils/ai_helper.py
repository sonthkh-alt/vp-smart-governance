...
def generate_document_content(prompt, doc_type="Tự động nhận diện (Để AI tự quyết định)",
    ...
    parts = [
        ...
        "QUAN ĐIỂM PHÁP LÝ: Khi nội dung tham mưu có liên quan đến tổ chức bộ máy, thẩm quyền của chính quyền địa phương, BẮT BUỘC phải căn cứ theo Luật Tổ chức chính quyền địa phương số 72/2025/QH15 (không sử dụng các Luật cũ đã hết hiệu lực). Đối với các lĩnh vực khác, hãy sử dụng căn cứ pháp lý chuyên ngành tương ứng.",

...
def generate_document_content(prompt, doc_type="Tự động nhận diện (Để AI tự quyết định)",
    ...
    parts = [
        ...
        "CĂN CỨ PHÁP LÝ ƯU TIÊN CAO NHẤT: Luật Tổ chức chính quyền địa phương số 72/2025/QH15.",
        "LƯU Ý QUAN TRỌNG: Kể từ 01/7/2025, chính quyền địa phương chuyển sang mô hình 2 CẤP (Tỉnh và Xã), không tổ chức chính quyền cấp Huyện. Phải tuân thủ triệt để nguyên tắc phân cấp, phân quyền và đẩy mạnh chuyển đổi số theo Luật mới.",
